...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \SIO\BourseBundle\Services\Graph\PHPGraphLib A SIO\BourseBundle\Services\Graph\PHPGraphLib instance.
     */
    protected function getLaFleurSymfony_PanierService()
    {
        return $this->services['la_fleur_symfony.panier'] = new \SIO\BourseBundle\Services\Graph\PHPGraphLib();
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('565f036a6c1c56.41206498')), true);
