...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'la_fleur_symfony.panier' => 'getLaFleurSymfony_PanierService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'LaFleurSymfonyBundle', ($this->targetDirs[2].'/Resources/LaFleurSymfonyBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'LaFleurSymfonyBundle', ($this->targetDirs[3].'\\src\\SIO\\LaFleurSymfonyBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BourseBundle', ($this->targetDirs[2].'/Resources/BourseBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BourseBundle', ($this->targetDirs[3].'\\src\\SIO\\BourseBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4b5c1dd54619dc2cd4c575c6f7cbebe0b5b10fbf3c2b1ed6360a4b1da4957820');
    ...
    /**
     * Gets the 'la_fleur_symfony.panier' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SIO\LaFleurSymfonyBundle\Services\Panier\Panier A SIO\LaFleurSymfonyBundle\Services\Panier\Panier instance.
     */
    protected function getLaFleurSymfony_PanierService()
    {
        return $this->services['la_fleur_symfony.panier'] = new \SIO\LaFleurSymfonyBundle\Services\Panier\Panier();
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'LaFleurSymfonyBundle', 1 => 'BourseBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\SIO\\LaFleurSymfonyBundle/Resources/views'), 'LaFleurSymfony');
        $instance->addPath(($this->targetDirs[3].'\\src\\SIO\\BourseBundle/Resources/views'), 'Bourse');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('0ce8275757365defe176f2abf13be951771823ab');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('564deda5d52606.31202295')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'LaFleurSymfonyBundle' => 'SIO\\LaFleurSymfonyBundle\\LaFleurSymfonyBundle',
                'BourseBundle' => 'SIO\\BourseBundle\\BourseBundle',
            ...
            'secret' => '0ce8275757365defe176f2abf13be951771823ab',
            'locale' => 'en',
            ...
            'kernel.secret' => '0ce8275757365defe176f2abf13be951771823ab',
